# Projeto Clean Code e Clean Architecture
...
Para acessar a documentação da API, basta iniciar a aplicação e acessar a URL do [Swagger](http://localhost:8091/swagger-ui.html)
